#!/bin/bash
#shadowsocks-libev obfs install by Recode IDX
# My Telegram : https://t.me/Stance999
# ==========================================
# Color
RED='\033[0;31m'
NC='\033[0m'
...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/gustipwa009/server-sragen/main/ipvps/izin.txt | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
echo -e "${NC}${LIGHT}WhatsApp : 087718794789"
echo -e "${NC}${LIGHT}Telegram : https://t.me/Stance999"
exit 0
fi
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/gustipwa009/server-sragen/main/shadowsocks"
