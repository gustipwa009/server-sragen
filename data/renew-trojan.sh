...
clear
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/usr/local/etc/xray/netz/trojantcp.json")
...
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/netz/trojantcp.json
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/netz/trojantcpnon.json
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/netz/trojanws.json
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/netz/trojanwsnon.json
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/netz/trojankuota.json
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/netz/trojangrpc.json
