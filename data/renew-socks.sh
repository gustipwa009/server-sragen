...
clear
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/usr/local/etc/xray/netz/socksws.json")
...
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/netz/socksws.json
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/netz/sockswsnon.json
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/netz/sockskuota.json
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/netz/socksgrpc.json
service cron restart
clear
echo ""
echo " SOCKS5 Berhasil Diperpanjang !"
echo " =========================="
